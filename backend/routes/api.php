...
Route::get('/kabar', [KabarController::class, 'indexActive']); // Untuk landing page anggota
...
Route::middleware('auth:sanctum')->group(function () {
    ...
    Route::get('/user/financial-summary', [UserController::class, 'getSilaContext']); // Endpoint untuk SILA Chat
    ...
    Route::get('/financing/catalog', [AdminController::class, 'indexCatalog']); // Mengambil dari gudang katalog
    ...
    Route::prefix('admin')->group(function () {
        ...
        // Manajemen Transaksi (AdminTransactions.tsx)
        ...
        // Manajemen Katalog Barang (CreditWarehouse.tsx)
        ...
        // Manajemen Toko (AdminTokoKatalog.tsx)
        Route::post('/shop/upload', [AdminController::class, 'uploadShopImage']);
        // Anda perlu menambahkan rute CRUD produk toko di sini

        // Manajemen TAMASA (AdminTamasa.tsx)
        Route::get('/tamasa', [AdminController::class, 'indexTamasa']); // Sesuaikan method di AdminController
        ...
        // Manajemen Gadai (AdminPegadaian.tsx)
        ...
        // Manajemen Penarikan Simpanan (AdminSimpanan.tsx)
        ...
        // Manajemen Kabar (AdminKabar.tsx)
        ...
        // Manajemen INFLIP (AdminInflip.tsx)
